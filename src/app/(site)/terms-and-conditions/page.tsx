    ...
    <article className="wrap max-w-3xl py-12 sm:py-16">
      ...
      <div className="prose-dark mt-10">
        ...
        <p>
          ...
          unauthorized access to any part of the site, interfere with its operation, or use it to
          transmit harmful or unlawful or unauthorized content.
        </p>

        <h2>3. Content and intellectual property</h2>
        <p>
          All content on this website — text, graphics, logos and software — is the property of
          Compublue or its licensors and is protected by copyright and trademark law. You may not
          reproduce or redistribute it without our written permission. Photography is used under
          license from its respective owners.
        </p>
